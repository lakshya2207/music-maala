  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 left-4 z-20 hidden md:flex items-center gap-1.5 glass rounded-full px-3.5 py-1.5 text-xs text-cream hover:text-amber transition-all hover:scale-105 border border-white/20 shadow-lg"
